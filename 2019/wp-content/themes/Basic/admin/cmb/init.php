...
if ( ! class_exists( 'CMB2_Bootstrap_223_Trunk', false ) ) {
	...
	class CMB2_Bootstrap_223_Trunk {
		...
		public function include_cmb() {
			...
			if ( ! defined( 'CMB2_DIR' ) ) {
				define( 'CMB2_DIR', trailingslashit( get_template_directory() . '/admin/cmb' ) );
			}
		...
		// 	$loaded = load_plugin_textdomain( 'Basic', false, '/languages/' );

		// 	if ( ! $loaded ) {
		// 		$loaded = load_muplugin_textdomain( 'Basic', '/languages/' );
		// 	}

		// 	if ( ! $loaded ) {
		// 		$loaded = load_theme_textdomain( 'Basic', get_stylesheet_directory() . '/languages/' );
		// 	}

		// 	if ( ! $loaded ) {
		// 		$locale = apply_filters( 'plugin_locale', get_locale(), 'Basic' );
		// 		$mofile = get_template_directory() . '/admin/cmb/languages/cmb2-' . $locale . '.mo';
		// 		load_textdomain( 'Basic', $mofile );
		// 	}
